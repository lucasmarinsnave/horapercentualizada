...
/////
////////
////////  DO DIA UTIL, HORARIO COMERCIAL DE HOJE
//////// 
/////

document.write('<br><br><br><br><b>!<br>PERCENTUAL DO DIA UTIL, HORARIO COMERCIAL DAS 8 HORAS AS 18 HORAS<br><br>!!!<br><br></b>');

document.write('<b>Estamos em % das horas </b> do Dia ' + str_data + '<br><br>');


// Mostra o resultado
document.write(hora100util + '% do Dia');
var ia = 0; var len1 = hora100util;
document.write('<br>');
for (; ia < len1; ia++) {   document.write('|'); }
// Linha 100
document.write('<br>');
...
document.write('<br><br><b> Faltam ainda </b>');
document.write('do Dia ' + str_data + '<br><br>');
...
// Mostra o resultado
document.write(hora100faltautil + '% do dia de hoje');
var ia = 0; var len1 = hora100falta;
document.write('<br>');
for (; ia < len1; ia++) {   document.write('|'); }
// Linha 100
